...
?>
    ...
    <div class="ui segment">
        ...
        <h3 class="ui orange right floated header">Courriers électroniques e-mails (réponse asynchrone)</h3>
        ...
        <div class="ui bottom attached active tab segment" data-tab="one">
            <div class="ui list">
                <div class="item">http://api.ecampaign.prosoluce.fr/sendMail</div>
            </div>
    ...
    <div class="ui basic buttons">
        ...
        <a href="compose_asynchrone.php" class="ui button">Retour</a>
    </div>
    </div>
    </div>
