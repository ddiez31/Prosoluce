<div id="d_cont">
    <div class="ui segment">
        ...
        <h3 class="ui orange right floated header">Création ou modification d'un modèle</h3>
        ...
        <div class="ui bottom attached active tab segment" data-tab="one">
            ...
            <div class="ui list">
                <div class="item">
                    <h5>Création</h5>http://api.ecampaign.prosoluce.fr/manageTemplate/add</div>
                <div class="item">
                    <h5>Modification</h5>http://api.ecampaign.prosoluce.fr/manageTemplate/*ID_MODELE*/mod</div>
            ...
            <<<<<<< HEAD </div>
                <div class="ui bottom attached tab segment" data-tab="two">
                    ...
                    <?php echo'<pre><code class="html" id="post-shortlink-two">'; highlight_file('./pages/codes_xml/code_requetes/req_modele_creat_mod.php');  echo'</code></pre>'; ?>
                </div>
                <div class="ui bottom attached tab segment" data-tab="three">
                    ...
                    <?php echo'<pre><code class="html" id="post-shortlink-three">'; highlight_file('./pages/codes_xml/code_reponses/resp_modele_creat_mod.php');  echo'</code></pre>'; ?>
