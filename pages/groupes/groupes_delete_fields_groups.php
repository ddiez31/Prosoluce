<div id="d_cont">
    <div class="ui segment">
        ...
        <h3 class="ui orange right floated header">Supprimer des champs dans un groupe</h3>
        ...
        <div class="ui bottom attached active tab segment" data-tab="one">
            <p>Supprimer des champs dans un groupe d'envoi existant.</p>
            <h4>URL d’appel</h4>
            <div class="ui list">
                <div class="item">http://api.ecampaign.prosoluce.fr/manageGroup/*ID_GROUPE*/delTags</div>
            </div>
        ...
        <div class="ui bottom attached tab segment" data-tab="two">
            ...
            <?php echo'<pre><code class="html" id="post-shortlink-two">'; highlight_file('./pages/codes_xml/code_requetes/req_delete_champs_group.php');  echo'</code></pre>'; ?>
        </div>
        <div class="ui bottom attached tab segment" data-tab="three">
            ...
            <?php echo'<pre><code class="html" id="post-shortlink-three">'; highlight_file('./pages/codes_xml/code_reponses/resp_delete_champs_group.php');  echo'</code></pre>'; ?>
