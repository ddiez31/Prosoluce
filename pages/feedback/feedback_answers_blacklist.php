<div id="d_cont">
    <div class="ui segment">
        ...
        <div class="ui bottom attached tab segment" data-tab="two">
            ...
            <?php echo'<pre><code class="html" id="post-shortlink-two">'; highlight_file('./pages/codes_xml/code_requetes/req_modele_blacklist_obtention_list.php');  echo'</code></pre>'; ?>
        </div>
        <div class="ui bottom attached tab segment" data-tab="three">
            ...
            <?php echo'<pre><code class="html" id="post-shortlink-three">'; highlight_file('./pages/codes_xml/code_reponses/resp_modele_blacklist_obtention_list.php');  echo'</code></pre>'; ?>
