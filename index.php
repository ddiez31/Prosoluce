...
// include ('pages/tables/table_gest_grp_model.php');
// include ('pages/tables/table_gest_cred.php');
// include ('pages/tables/table_gest_answer_and_blacklist.php');
// include ('pages/tables/table_suivi_envois.php');
// include ('pages/tables/table_info_number_phone.php');
...
// include ('pages/tables/table_register_model_voice.php');
