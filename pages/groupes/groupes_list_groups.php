<div id="d_cont">
    <div class="ui segment">
        ...
        <h3 class="ui orange right floated header">Listes des groupes existants</h3>
        ...
        <div class="ui bottom attached active tab segment" data-tab="one">
            <p>Récupère la liste des groupes d'envoi existants.</p>
            <h4>URL d’appel</h4>
            <div class="ui list">
                <div class="item">http://api.ecampaign.prosoluce.fr/manageGroup/listGroups</div>
            </div>
        ...
        <div class="ui bottom attached tab segment" data-tab="two">
            ...
            <?php echo'<pre><code class="html" id="post-shortlink-two">'; highlight_file('./pages/codes_xml/code_requetes/req_group_list.php');  echo'</code></pre>'; ?>
        </div>
        <div class="ui bottom attached tab segment" data-tab="three">
            ...
            <?php echo'<pre><code class="html" id="post-shortlink-three">'; highlight_file('./pages/codes_xml/code_reponses/resp_group_list.php');  echo'</code></pre>'; ?>
