<div id="d_cont">
    <div class="ui segment">
        ...
        <h3 class="ui orange right floated header">Information sur un modèle</h3>
        ...
        <div class="ui bottom attached active tab segment" data-tab="one">
            ...
            <h4>Description des paramètres d'appel</h4>
        ...
        <div class="ui bottom attached tab segment" data-tab="two">
            ...
            <?php echo'<pre><code class="html" id="post-shortlink-two">'; highlight_file('./pages/codes_xml/code_requetes/req_methode_list_get.php');  echo'</code></pre>'; ?>
        </div>
        <div class="ui bottom attached tab segment" data-tab="three">
            ...
            <?php echo'<pre><code class="html" id="post-shortlink-three">'; highlight_file('./pages/codes_xml/code_reponses/resp_methode_list_get.php');  echo'</code></pre>'; ?>
