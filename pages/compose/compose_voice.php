<div id="d_cont">
    <div class="ui segment">
        ...
        <h3 class="ui orange right floated header">Appels téléphoniques voix (réponse synchrone)</h3>
        ...
        <div class="ui bottom attached tab segment" data-tab="two">
            ...
            <?php echo'<pre><code class="html" id="post-shortlink-two">'; highlight_file('./pages/codes_xml/code_requetes/req_mess_voice.php');  echo'</code></pre>'; ?>
        </div>
        <div class="ui bottom attached tab segment" data-tab="three">
            ...
            <?php echo'<pre><code class="html" id="post-shortlink-three">'; highlight_file('./pages/codes_xml/code_reponses/resp_mess_voice.php');  echo'</code></pre>'; ?>
            ...
            <?php include ('pages/code_errors/codes_etat_appels.php'); ?>
        </div>
        ...
        <div class="ui bottom attached tab segment" data-tab="four">
            ...
            <p id="post-shortlink-four">
                <?php highlight_file('./classes/ecampaign_class_voice.php') ?>
            </p>
        </div>
    </div>
