...
class ecampaign{
	 ...
	 * @param $callerid Numéro d'appelant pour les SMS vocalisés (optionnel)
	 ...
	 */
	public function sendSMS($route, $recipients, $message=null, $senderid=null, $callerid=null, $template_id=null, $send_date=null, $group_id=null, $group_fields=null, $group_filter=false, $group_filter_global_op=null, $group_filter_criterias=null){
		$req  = "<sendSMS>\n";
